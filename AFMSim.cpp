...
int	main(int argc, char *argv[])
{
    ...
    Surface* 		surface 		=	new Surface(a1, a2, a3, a1_cells, a2_cells, a3_cells, simple_cell); 	// Surface generation, unit cell is tiled
    VestaObject* 	Defect 	= 	new VestaObject(0, 0, 0);																// over space in the directions defined by a1,a2,a3
